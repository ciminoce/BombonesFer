...
namespace Bombones.Windows
{
    public partial class frmChocolatesAE : Form
    {
        ...
        private TipoDeChocolate tipoChocolate;      // variable de tipo TipoDeChocolate
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            if (ValidarDatos())
            {
                ...
                tipoChocolate.Stock = (int)nudStock.Value;       // la propiedad Stock toma el valor decimal del objeto numeric up down y lo convierte a entero
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (tipoChocolate != null)
            {
                ...
                nudStock.Value = tipoChocolate.Stock;
            }
        }
    }
}
